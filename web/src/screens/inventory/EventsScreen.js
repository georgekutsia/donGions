        ...
        <div  className="d-flex justify-content-evenly">
          ...
          <div className="riddles-big-box">
            <FadeInOut show={ridles} duration={500}>
              <div  className="d-flex justify-content-evenly">
                ...
                <FadeInOut show={robot1} duration={500}>
                  <div className="prueba-robot">
                    ...
                    <Riddles nombrePrueba={"Objetivo 2"} respuesta1={"pdpppipppppippp"} respuesta2={"pipppppdpppp"} respuesta3={"pdppippppippp"} placeHolder={"Objetivo 2"} mensajePruebaFallida={"Objetivo no conseguido"} mensajeBienHecho={"¡Buen trabajo!"}/>
                    <Riddles nombrePrueba={"Objetivo 3"} respuesta1={"pi4xpd8xpd8xpd2xp"} respuesta2={"2xpi3xpd7xpd7xpd2xp"} respuesta3={"dongions&drogas"}  placeHolder={"Objetivo 3"} mensajePruebaFallida={"Objetivo no conseguido"} mensajeBienHecho={"¡Tercer objetivo conseguido!"}/>
                    <Riddles nombrePrueba={"Objetivo 4"} respuesta1={"4x(pipd)"} respuesta2={"2x(pdpi)ppip"} respuesta3={"dongions&drogas"}  placeHolder={"Objetivo 4"} mensajePruebaFallida={"Objetivo no conseguido"} mensajeBienHecho={"Cuarto objetivo conseguido. ¡Sólo queda uno!"}/>
              ...
              <Riddles nombrePrueba={"Prueba 2"} respuesta1={"huha"} respuesta2={"pdpppipppppippp"} respuesta3={"dongions&drogas"}  placeHolder={"prueba 2"} mensajePruebaFallida={"Objetivo no conseguido"} mensajeBienHecho={"¡Primer objetivo conseguido!"}/>
              <Riddles nombrePrueba={"Prueba 4"} respuesta1={"huha"} respuesta2={"pdppipppppip"} respuesta3={"dongions&drogas"}  placeHolder={"prueba 4"} mensajePruebaFallida={"Objetivo no conseguido"} mensajeBienHecho={"¡Primer objetivo conseguido!"}/>

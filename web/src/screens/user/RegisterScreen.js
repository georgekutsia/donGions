...
import { CarouselImgs1, Register } from "../../component";
    ...
    <div align="center" style={{ paddingBottom: "129px" }}>
        ...
        {buttons && (
          <div className="d-flex">
            ...
            >
              ...
              <span></span>
              <span></span>
              <span></span>Regresar a la página de inicio
            </Link>
          </div>
        )}
        ...
        {showVideosBiblioplex && (
          <div>
            ...
            >
              ...
              <span></span>
              <span></span>
              <span></span>Archivos recuperados de Alberignos
            </Link>
          </div>
        )}
      </FadeInOut>
      <FadeInOut show={showVideosBiblioplex} duration={1000}>
        {showVideosBiblioplex && (
          <button
            className="btn-rules-toggle"
            style={{ color: "blue", fontSize: "calc(10px + 0.5vw)" }}
            onClick={handelInspi}
          >
            <span></span>
            <span></span>
            <span></span>
            <span></span>Inspírate un poco más...
          </button>
        )}
      </FadeInOut>
      <div className="m-1">
        <FadeInOut show={showCarousel} duration={5000}>
          <div>{showCarousel && <CarouselImgs1 />}</div>
        </FadeInOut>
      </div>
      <div>
        <FadeInOut show={inspi1} duration={200}>
          {inspi1 && (
            <img
              className="m-2"
              width="90%"
              src="https://res.cloudinary.com/dfrda73uc/image/upload/v1666698260/donGions%20imgs/rules%2B/Captura_de_pantalla_2022-10-25_a_las_13.42.46_dl8bcg.png"
              alt="inspire 1"
            />
          )}
        </FadeInOut>
        <FadeInOut show={inspi2} duration={200}>
          {inspi2 && (
            <img
              className="m-2"
              width="90%"
              src="https://res.cloudinary.com/dfrda73uc/image/upload/v1666698261/donGions%20imgs/rules%2B/Captura_de_pantalla_2022-10-25_a_las_13.43.02_gpniud.png"
              alt="inspire 2"
            />
          )}
        </FadeInOut>
        <FadeInOut show={inspi3} duration={200}>
          {inspi3 && (
            <img
              className="m-2"
              width="90%"
              src="https://res.cloudinary.com/dfrda73uc/image/upload/v1666698260/donGions%20imgs/rules%2B/Captura_de_pantalla_2022-10-25_a_las_13.43.10_qvo0xf.png"
              alt="inspire 3"
            />
          )}
        </FadeInOut>
        ...
        <div>
          {showRegister && (
            ...
            >
              ...
              <span></span>
              <span></span>
              <span></span>Comenzar con el Registro
            </Link>
          )}
        </div>
      </FadeInOut>

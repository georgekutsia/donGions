...
console.log("valor", value)
  ...
  return (
    <FadeInOut show={showPage} duration={800}>
        <div className={back ? "moving-background-scenary" : "moving-background-part"} id='profile-size-bo' align="center">
          <div className="nav-items-pj">
              <Link className='nav-items-pj-item' style={{color:"grey"}} onClick={()=> setBack(!back)}>{back ? 
                <i className="fa-solid fa-moon"></i>: <i className="fa-solid fa-mountain-sun"></i>} </Link>
        ...
        <div className="box-img-planeswalker">
              ...
              <img className={smoller ?'profile-image-css':"profile-image-css-smoll"} style={{border:`${statis.style} 3px solid`}} width="360px" src={statis.image} alt="dasda" />
              </Link>
            ...
            <div  className={smoller ? "box-big-stats-div":"box-small-stats-div"}>
              <FadeInOut show={showPage} duration={1200}>
                <div className=' float-start'>
                    <div  className='inner-box-stats m-5' style={{ border :`20px ${statis.style} ridge`}}>
                          <StatsSalud/>
                          <StatsDam />
                          <StatsDefence/>

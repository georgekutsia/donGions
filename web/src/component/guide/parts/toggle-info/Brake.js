...
function Brake() {
  return (
    <div align="center"  className='background-list-actions'>
        ...
        <article className="definicion-concepto"> Las armas cuerpo a cuerpo marcan su probabilidad de romperse si fallas. Debes superar con el dado lo que marca el arma para que no se rompa al impactar.
